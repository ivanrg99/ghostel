...
;; the live prompt; p / P paste; u sends readline undo.  Word motions and
;; text objects use Vim-style boundaries by default; customize
;; `evil-ghostel-word-boundaries' to retain Ghostel's path-aware boundaries.
;;
